...
//
// Extracted from air-quality-card.js so the math, threshold tables, and
// translation strings can be unit-tested without spinning up a DOM and
// imported by both the card and the test suite. Anything DOM-aware
...
export function translate(path, lang = 'en') {
...
// tables above).
export function calcThreshold(value, good, mod, high) {
...
export function computeScore({ pm25, voc, co2 }) {
  const pollutants = [
